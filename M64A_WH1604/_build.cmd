...
set TFT_FILES=%~d0\PROG_AVR\_lib_tft_ili9486
set FONT_FILES=%~d0\PROG_AVR\_fonts
...
if errorlevel 1 goto err
	...
	REM %OBJ_FILES%\tft_ili9486.o ^
	REM %OBJ_FILES%\Font_Tahoma10.o ^
	REM %OBJ_FILES%\Font_Tahoma20.o ^
